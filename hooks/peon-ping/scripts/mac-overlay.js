...
function run(argv) {
  ...
  // Color map — default PMS 728 (Star Trek gold) #C6A96C
  var r = 198/255, g = 169/255, b = 108/255;
  switch (color) {
    case 'blue':   r = 198/255; g = 169/255; b = 108/255; break;
    case 'yellow': r = 198/255; g = 169/255; b = 108/255; break;
    case 'red':    r = 198/255; g = 169/255; b = 108/255; break;
  }

  var bgColor = $.NSColor.colorWithSRGBRedGreenBlueAlpha(r, g, b, 1.0);
  var winWidth = 400, winHeight = 112;
  ...
  for (var i = 0; i < screenCount; i++) {
    ...
    win.contentView.layer.setBackgroundColor($.CGColorCreateGenericRGB(r, g, b, 1.0));
    ...
    // Message label — vertically centered, wrapping
    var font = $.NSFont.boldSystemFontOfSize(16);
    var lineHeight = font.ascender - font.descender + font.leading + 4;
    var textAreaHeight = lineHeight * 3;
    var textY = (winHeight - textAreaHeight) / 2;
    var label = $.NSTextField.alloc.initWithFrame(
      $.NSMakeRect(textX, textY, textWidth, textAreaHeight)
    );
